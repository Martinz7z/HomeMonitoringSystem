...
{
    console.log("message here",message.humidity_value)
    if(message.humidity_value > 0 || message.humidity_value < 100)
    {
        document.getElementById("humidity").innerHTML = message.humidity_value;
    }
    if(message.humidity_value < 0 || message.humidity_value > 100)
    {
